...
def remove_portfolio():
    ...
    if ticker in portfolio.keys():
        ...
        print(f"You dont own any shares of that {ticker}")
...
def plot_chart():
    ticker = input("Chooose a ticker symbole: ")
    ...
    mpf_style = mpf.make_mpf_style(base_mpf_style='nightclouds', market=colors)
...
assistant = BasicAssistant('intents.json', mappings, 'financial_assistant_model')
